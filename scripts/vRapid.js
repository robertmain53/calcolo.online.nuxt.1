...
const records = JSON.parse(fs.readFileSync('content/rapidTablesCalculators.json', 'utf-8'));
const urls    = JSON.parse(fs.readFileSync('data/rapidtablesTools.json', 'utf-8'));
...
(async () => {
  ...
  // Salva report
  const outPath = path.resolve('report', 'validationReportRapid.json');
