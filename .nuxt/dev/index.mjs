...
import { escapeHtml } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/nitropack/node_modules/source-map/source-map.js';
...
import { isAbsolute } from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///workspaces/calcolo.online.nuxt.1/node_modules/db0/dist/connectors/better-sqlite3.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/workspaces/calcolo.online.nuxt.1/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/calcolo.online.nuxt.1","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/calcolo.online.nuxt.1/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/calcolo.online.nuxt.1/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/calcolo.online.nuxt.1/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/calcolo.online.nuxt.1/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/workspaces/calcolo.online.nuxt.1/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _XVKG7UXcjYswL_X4zAvPjkMyeS1zSglMJrcRiKAaAM = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/workspaces/calcolo.online.nuxt.1";
...
const _cm7sQ1gLbI0EqBxdm4tXnYuXY7G33ZIe09vUHUn3H8 = (nitroApp) => {
...
const plugins = [
  _XVKG7UXcjYswL_X4zAvPjkMyeS1zSglMJrcRiKAaAM,
...
const getServerEntry = () => import('file:///workspaces/calcolo.online.nuxt.1/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///workspaces/calcolo.online.nuxt.1/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _4CSy7N = eventHandler(async (event) => {
  ...
  return await import('file:///workspaces/calcolo.online.nuxt.1/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const checksums = {
  "content": "v3.5.0--5V9JNvX4HKjRCXiOpxKMZGdN1ZDEEWT0l_zU2fgXRsI"
};
...
const _0K7awV = eventHandler(async (event) => {
...
const _lazy_ay3oLX = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ay3oLX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _4CSy7N, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _0K7awV, lazy: false, middleware: false, method: undefined },
